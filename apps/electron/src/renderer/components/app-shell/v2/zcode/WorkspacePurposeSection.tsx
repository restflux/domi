      ...
      <Collapsible open={open} onOpenChange={onOpenChange}>
        <div className="flex h-7 min-w-0 items-center">
          <CollapsibleTrigger asChild>
            ...
            <button
              type="button"
              className="flex h-7 min-w-0 flex-1 items-center gap-1 px-2.5 text-left text-xs font-medium text-muted-foreground outline-none transition-colors hover:text-foreground focus-visible:text-foreground focus-visible:ring-2 focus-visible:ring-ring/30"
            >
          ...
          <div className="flex shrink-0 items-center pr-1.5 opacity-0 transition-opacity group-hover/purpose-section:opacity-100 group-focus-within/purpose-section:opacity-100 has-[[data-state=open]]:opacity-100 [@media(hover:none)]:opacity-100">
            <button
              ...
              className="flex size-6 touch-none cursor-grab items-center justify-center rounded-md text-muted-foreground outline-none hover:bg-accent hover:text-foreground focus-visible:ring-2 focus-visible:ring-ring/30 active:cursor-grabbing"
              {...attributes}
              {...listeners}
            >
