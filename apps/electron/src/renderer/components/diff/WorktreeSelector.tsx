...
import type { WorktreeInfo, WorkspaceWorktreeRepo } from '@domi/shared'
...
export function WorktreeSelector({
  ...
  return (
    <div ref={dropdownRef} className="relative px-3 py-1.5 border-b border-border/50">
      ...
      {isOpen && (
        <div className="absolute left-2 right-2 top-full mt-0.5 z-50 bg-popover border border-border rounded-md shadow-md py-1 max-h-[240px] overflow-y-auto scrollbar-thin">
          <button
            onClick={() => {
              onSelect(null)
              setIsOpen(false)
