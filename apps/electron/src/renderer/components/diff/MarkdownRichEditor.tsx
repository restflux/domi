    ...
    <div className={cn('flex flex-col', editing ? 'h-full' : 'min-h-full')}>
      ...
      <EditorContent
        ...
        className={cn(
          ...
          isEditable
            ? '[&_.domi-mermaid-preview]:hidden [&_.domi-code-source-body]:block'
            : [
                '[&_.domi-code-block--mermaid]:overflow-visible',
                '[&_.domi-code-block--mermaid]:rounded-none',
                '[&_.domi-code-block--mermaid]:border-0',
                '[&_.domi-code-block--mermaid]:bg-transparent',
                '[&_.domi-code-block--mermaid_.domi-code-header]:hidden',
                '[&_.domi-code-block--mermaid_.domi-mermaid-preview]:block',
                '[&_.domi-code-block--mermaid_.domi-code-source-body]:hidden',
              ],
        )}
      />
