    ...
    groups.get('edit')?.push(
      {
        id: 'send-message',
        name: '发送消息',
        description: '在 Chat 或 Work 输入框中发送当前内容',
    ...
    <DialogPrimitive.Root open={open} onOpenChange={setOpen}>
      <DialogPrimitive.Portal>
        ...
        >
          ...
          <div className="grid flex-1 grid-cols-1 content-start gap-x-8 gap-y-7 overflow-y-auto scrollbar-thin px-6 py-6 lg:grid-cols-2">
