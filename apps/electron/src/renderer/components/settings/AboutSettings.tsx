...
import type { EnvironmentCheckResult, RuntimeStatus, WindowsShellPreference } from '@domi/shared'
import {
  SettingsSection,
  SettingsCard,
  SettingsRow,
        ...
        {!hasShell && (
          <Alert variant="destructive">
            ...
            <AlertDescription className="text-xs">
              ...
              <br />
              Work 模式需要 Git Bash 或 WSL 才能运行。请安装其中之一后重启应用。
            </AlertDescription>
          </Alert>
        )}
      </div>
...
export function AboutSettings(): React.ReactElement {
  return (
    <SettingsSection
      title="关于 Domi"
      description="Personal Coding Workbench"
    >
      <SettingsCard>
