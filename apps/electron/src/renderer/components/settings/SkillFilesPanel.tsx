...
import type { SkillFileNode, SkillFileContent } from '@domi/shared'
    ...
    <div className="flex flex-col h-full">
      ...
      <SettingsCard divided={false} className="flex-1 min-h-0">
        <div className="grid grid-cols-[minmax(220px,1fr)_2fr] h-full min-h-[420px]">
          {/* Tree */}
          <div className="border-r border-border bg-muted/30 p-2 overflow-y-auto scrollbar-thin">
            {loading ? (
            ...
            {!selected ? (
              ...
              <>
                ...
                {editing ? (
                  ...
                  <pre className="flex-1 bg-transparent text-xs font-mono p-3 overflow-auto scrollbar-thin whitespace-pre-wrap m-0">
                    {fileContent.content ?? ''}
                  </pre>
                )}
              </>
