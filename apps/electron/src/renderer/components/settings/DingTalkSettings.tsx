...
import type { DingTalkBotConfig, DingTalkBotBridgeState, DingTalkBridgeStatus, DingTalkTestResult } from '@domi/shared'
        ...
        <SettingsCard divided={false}>
          <div className="px-4 py-4 space-y-5 text-sm">
            ...
            <div className="space-y-1.5">
              ...
              <p className="pl-7 text-muted-foreground">
                在「应用能力」中启用机器人功能。
                然后回到 Domi，<span className="text-foreground font-medium">先点击「保存配置」</span>，
            ...
            <div className="pl-7 p-3 rounded-lg bg-amber-500/10 text-amber-700 dark:text-amber-400 text-xs">
              <span className="font-medium">重要：</span>配置事件订阅前，必须先在 Domi 中保存凭证并确认 Stream 连接成功，
