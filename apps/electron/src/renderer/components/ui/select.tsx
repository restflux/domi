...
>(({ className, children, position = "popper", ...props }, ref) => (
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ref={ref}
      className={cn(
        // 与 Dropdown / Popover 同款 lg 圆角 + hairline + shadow-lg
        "relative z-[100] max-h-[--radix-select-content-available-height] min-w-[8rem] overflow-y-auto scrollbar-thin overflow-x-hidden rounded-lg border border-border/50 bg-popover text-popover-foreground shadow-lg titlebar-no-drag",
