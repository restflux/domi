      ...
      {step === 'welcome' && (
        <>
          <div className="mb-12 text-center">
            <h1 className="text-4xl font-bold mb-4">欢迎使用 Domi</h1>
                ...
                >
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs text-muted-foreground mt-0.5">
                      ...
                      <br/>
                      <br/>
                      新备份使用 .domi-backup；旧 .domi-backup 也可选择导入
                    </p>
                  </div>
                </button>
                <button
                ...
                >
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-xs text-muted-foreground mt-0.5">
                      ...
                      <br/>
                      <br/>
                      新分享包使用 .domi-share；旧 .domi-share 也可选择导入
                    </p>
                  </div>
                </button>
              </div>
        ...
        <div className="w-full max-w-2xl">
          <div className="mb-6 text-center">
            ...
            <p className="text-sm text-muted-foreground">
              Domi 在 Windows 上需要 Git Bash 或 WSL 才能执行命令
            </p>
          </div>
