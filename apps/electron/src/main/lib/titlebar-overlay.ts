...
// Colors mirror each theme's rendered TabBar surface so the native Windows titlebar overlay
// joins the app chrome without a visible seam.
const THEME_COLORS: Record<string, { color: string; symbolColor: string }> = {
  'default-light': { color: '#f4f5f6', symbolColor: '#0a0a0a' },
  ...
  'ember-dark': { color: '#151d24', symbolColor: '#e8ebed' },
  'blossom-mist-light': { color: '#eef3f6', symbolColor: '#384047' },
  'cloud-citadel-light': { color: '#f0f5f3', symbolColor: '#255240' },
}
