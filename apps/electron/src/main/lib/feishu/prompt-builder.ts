 ...
 *      Domi 只把 user text 给 Agent，丢掉了"用户在问哪条消息"这个上下文。
 ...
 * 但 Domi 用动态系统提示词构建，BRIDGE_SYSTEM_PROMPT 作为
...
export const BRIDGE_USER_MESSAGE_PRELUDE = `<!-- 你正在通过 Domi 飞书桥处理来自飞书的用户消息。bridge 会用 XML 块注入
