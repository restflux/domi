...
import { APP_NAME } from '@domi/shared'
...
import { resolveTrayIconPath } from './lib/tray-icon'
...
/**
 * 获取托盘图标路径
 * macOS 使用单色 Template，Windows/Linux 使用彩色品牌图标。
 */
function getTrayIconPath(): string {
  ...
  return resolveTrayIconPath(resourcesDir, process.platform)
}
