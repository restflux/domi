...
export interface ReasoningCapability {
  source: 'profile' | 'provider-metadata' | 'pi-catalog' | 'temporary-adaptation'
  levels: readonly AgentThinkingLevel[]
  defaultLevel: AgentThinkingLevel
}
...
// DeepSeek's 2026-08-13 contract exposes three enabled efforts plus Off.
...
const DEEPSEEK_V4_EFFORT_MAP: ReasoningEffortMap = {
  low: 'low',
  high: 'high',
  max: 'max',
}
...
const DEEPSEEK_V4_FLASH_PROFILE: ReasoningProfile = {
  ...
  encodings: {
    'anthropic-messages': { kind: 'deepseek-output-effort', effortMap: DEEPSEEK_V4_EFFORT_MAP },
  },
}
