 ...
 * 仅通过 '@domi/session-core/node' 子路径暴露给 Node 侧（CLI / 主进程）。
 */
import type { AgentMessage, SDKMessage } from '@domi/shared'
